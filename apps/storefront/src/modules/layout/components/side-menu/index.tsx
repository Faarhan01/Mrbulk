...
import { ArrowRightMini, XMark, House, ShoppingBag, User } from "@medusajs/icons"
        ...
        <Popover className="h-full flex">
          {({ open, close }) => (
            <>
              {open && (
                <div
                  className="fixed inset-0 bg-overlay z-[48] lg:hidden pointer-events-auto"
                  onClick={close}
              ...
              >
                  ...
                  <div
                    ...
                    className="drawer-surface rounded-3xl border p-4 space-y-3 max-h-[85vh] overflow-y-auto shadow-2xl shadow-slate-900/10 dark:shadow-black/40"
                  >
